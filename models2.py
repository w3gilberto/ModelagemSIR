...
class SEIR:
    ...
    def get_fit_params(self, data):
        ...
        #parametro inicial encontrado na simulacao de 6meses: r0=3.5
        ...
        #params.add("alpha", value=0.032, min=0.005, max=0.0078, brute_step=0.0005, vary=True)
    ...
    def step(self, initial_conditions, t, params, history_store):
        ...
        new_dead = gamma * alpha * I   #de acordo com equacoes
...
class SEIR_ID(SEIR):
    def get_fit_params(self, data):
        ...
        #parametros inicias RJ encontrados na simulacao de 6meses
